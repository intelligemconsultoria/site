...
export function CasesSection() {
  ...
  return (
    <section id="cases" className="py-20 bg-gradient-to-b from-black to-gray-900/30">
      <div className="container mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          {cases.map((case_item, index) => (
            <Card 
              key={index}
              className="bg-white/5 border-white/10 hover:bg-white/10 hover:border-white/20 transition-all duration-300 group overflow-hidden"
            >
              ...
              <CardContent className="p-6 space-y-4">
                <div>
                  <h3 className="text-white text-xl mb-2">{case_item.title}</h3>
                  <p className="text-emerald-400 text-sm">{case_item.company}</p>
                </div>

                <div className="space-y-3">
                  <div>
                    <h4 className="text-white/80 text-sm mb-1">Desafio:</h4>
                    <p className="text-white/60 text-sm">{case_item.challenge}</p>
                  </div>

                  <div>
                    <h4 className="text-white/80 text-sm mb-1">Solução:</h4>
                    <p className="text-white/60 text-sm">{case_item.solution}</p>
                  </div>

                  <div>
                    <h4 className="text-white/80 text-sm mb-2">Resultados:</h4>
